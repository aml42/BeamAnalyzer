...
class BeamAnalyzer:
    ...
    easy-to-use interface. All inputs and outputs use pure SI units: m, N/m, Pa, m⁴, N, N·m.
    ...
    inertia : float | None, default None
        Moment of inertia in m⁴. If None, deflection calculations will be skipped.
    ...
    inertia : float | None
        Moment of inertia used for deflection calculations (in m⁴).
    e_modulus : float
        Elastic modulus used for deflection calculations (in Pa).
    num_points : int
    ...
    def plot_shear_diagram(self, save_path: str | None = None, **kwargs) -> plt.Axes:
        """
    ...
    def plot_moment_diagram(self, save_path: str | None = None, **kwargs) -> plt.Axes:
        """
    ...
    def plot_deflection_diagram(self, save_path: str | None = None, **kwargs) -> plt.Axes:
        """
    ...
    def plot_all_diagrams(self, save_path: str | None = None, figsize: tuple[int, int] = (15, 10)) -> tuple[plt.Figure, tuple[plt.Axes, plt.Axes, plt.Axes]]:
        """
